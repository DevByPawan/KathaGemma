...
export default function Voice() {
  ...
  // Simulating speech transcript typing during Listening state
  useEffect(() => {
    ...
    const script = [
      ...
      "Tell me a story about Pipo the Panda",
    ...
    const interval = setInterval(() => {
      if (step < script.length) {
        ...
        // Automatically transition to Thinking state after final transcript
        setTimeout(() => {
  ...
  // Speaking text typing animation
  useEffect(() => {
          ...
          <AnimatePresence mode="wait">
            ...
            {currentState === 'speaking' && (
              ...
              >
                ...
                >
                  <Button
                    onClick={() => navigate(`/choice?id=${storyId || ''}`)}
